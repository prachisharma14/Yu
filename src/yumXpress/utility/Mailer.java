...
public class Mailer {
    ...
    public static void sendMail(Map<String, String> emailCredentials, CustomerPojo customer) throws MessagingException {
        ...
        String emailSubject = "Welcome to yumXpress App- your Ultimate Companion of HAPPY MEAL!!!";

        String emailBody = "Dear " + customer.getCustomerName() + ",\n"
                + "\n"
                + "We are happy to have you as our esteemed customer.Please find the account information below:\n"
                + "\n"
                + "Customer ID: " + customer.getCustomerId() + "\n"
                + "Customer Name: " + customer.getCustomerName() + "\n"
                + "Email ID(Login Id): " + customer.getEmailId() + "\n"
                + "Intial Password: " + PasswordEncryption.getDecryptedPassword(customer.getPassword()) + "\n"
                + "\n"
                + "Happy Meal Time!!!.\n"
                + "Best regards,\n"
                + "\n"
    ...
    public static void sendMail(Map<String, String> emailCredentials, OrderPojo order) throws MessagingException{
        ...
        emailBody+="\nCompany Email-Id: "+order.getCompanyEmailId()+"\n";
        emailBody+="\nProduct Price: "+order.getProductPrice()+"\n";
        emailBody+="\nTax Amount: "+taxAmt+"\n";
        emailBody+="\nBill Amount: "+billAmount+"\n";
        emailBody+="\nDelivery Staff Name: "+order.getDeliveryStaffName()+"\n";
        emailBody+="\nOTP: "+order.getOtp()+"\n";
        emailBody+="Please share this OTP with your Delivery Partner.\n";
